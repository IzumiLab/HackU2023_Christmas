// Base: https://github.com/EnoxSoftware/ARFoundationWithOpenCVForUnityExample/blob/97434bc/Assets/ARFoundationWithOpenCVForUnityExample/Scripts/Utils/ARFoundationCameraToMatHelper.cs
...
namespace ARFoundationWithOpenCVForUnity.UnityUtils.Helper
{
    ...
    public class ARFoundationCameraToMatHelper : WebCamTextureToMatHelper
    {
        ...
        protected XROrigin _arSessionOrigin;

        public virtual XROrigin arSessionOrigin
        {
...
#if (UNITY_IOS || UNITY_ANDROID) && !UNITY_EDITOR && !DISABLE_ARFOUNDATION_API || true
...
#if UNITY_EDITOR
                XRCpuImage.Transformation.MirrorX // よくわからないけどエディタだと反転するので修正
#else
